...
import 'dart:io';
// import 'dart:convert'; // RETIRÉ : Plus besoin de base64
...
class _StockCreateScreenState extends State<StockCreateScreen> {
  ...
  Future<File?> _compressImage(File file) async {
    ...
    // Compression optimisée pour catalogue (max 800x800)
  ...
  Future<void> _submit() async {
    ...
    // MODIFIÉ : On n'encode plus en Base64.
    ...
    final productData = {
      ...
      // 'image_url': ... RETIRÉ (géré par le fichier)
    };

    try {
      // MODIFIÉ : Appel avec le paramètre nommé 'imageFile'
      await stock.addProduct(productData, imageFile: _imageFile);
      ...
      WinkDialog.show(
        ...
        dialog: WinkDialog.success(
          title: "Produit Créé !", 
          message: "L'article a été ajouté avec sa photo au catalogue.", 
          onPressed: () {
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              const Center(child: Text("(Optionnel : Photo Catalogue)", style: TextStyle(color: Colors.grey, fontSize: 12))),
